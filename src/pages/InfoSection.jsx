...
const imageData = [
  ...
  },
  {
    ...
    description: 'Participants will receive their challenge topics on the day of the event. Domains include Web Development, App Development and Aritificial Intelligence. Pre-prepared projects will not be accepted.',
...
const InfoSection = () => {
  return (
    <div className="flex flex-col mx-auto md:w-[90%]" id="Instructions">
