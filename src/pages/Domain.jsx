    ...
    const cards=[
        {
            ...
            description:"Build dynamic and responsive web applications. Showcase your skills in front-end, back-end, or full-stack development."
        },
        {
            animationData:aniData2,
            title:"Mobile App Development",
            description:"Create intuitive and impactful mobile apps that enhance user experiences. Whether native or cross-platform."
        },
        {
            animationData:aniData3,
            title:"Artificial Intelligence",
            description:"Develop intelligent systems using the latest in AI and machine learning."
        }
        ];
  return (
