...
function Home() {
  return (
    <div className='text-white pt-24 p-6' >
        <div className='md:flex items-center justify-center gap-x-44'>
            <div className='p-5'>
                <h1 className='font-serif text-white text-7xl text-center hover:text-orange-700 duration-75'>CODECRUX</h1>
            </div>
