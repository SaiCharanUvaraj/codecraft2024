const Footer = () => {
  return (
    <footer className="text-white text-xl pt-24 w-full">
            ...
            <div className="grid place-items-center gap-1">
                ...
                <div className="flex pt-4 space-x-6">
                    <a href="https://www.instagram.com/mtechcsesairam/" className="hover:scale-125 active:scale-95 transition-all duration-300">
                        <svg className="bg-rose-400 rounded-xl" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" color="">
                    ...
                    <a href="https://www.facebook.com/SairamEnggMtechCSE/" className="hover:scale-125 active:scale-95 transition-all duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" className="text-white bg-blue-600 rounded-xl">
                    ...
                    <a href="https://in.linkedin.com/in/sairam-m-tech-cse-794733229" className="hover:scale-125 active:scale-95 transition-all  duration-300">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" className="text-white bg-blue-400 rounded-xl">
